  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
      ...
      <img 
        src={brushstrokes} 
        alt="" 
        className="absolute bottom-24 left-4 md:left-12 w-40 md:w-56 h-auto opacity-[0.12] animate-float pointer-events-none rotate-180"
      ...
      <img 
        src={brushstrokes} 
        alt="" 
        className="absolute top-1/3 left-1/4 w-32 md:w-44 h-auto opacity-[0.08] animate-float pointer-events-none -rotate-12"
